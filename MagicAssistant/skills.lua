...
skills[14] = {
    ...
    [320] = {en = 'Konzen\-ittai', skillchain = {'Light', 'Darkness', 'Gravitation', 'Fragmentation', 'Distortion', 'Fusion', 'Liquefaction', 'Induration', 'Reverberation', 'Compression', 'Impaction'}, dur = 10},
    }
